 ...
 * @generated
 */
public class ActionShowsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActionShowsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Dialog) {
			return false;
		}
		if (getSource() == null) {
		...
		return AndroidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateActionShows_4006(getSource(), getTarget());
	}
