...
import android.diagram.edit.commands.MenuHasItemCreateCommand;
import android.diagram.edit.commands.MenuHasItemReorientCommand;
...
public class MenuItemSemanticEditPolicy extends
	...
	public MenuItemSemanticEditPolicy() {
		super(AndroidElementTypes.Menu_2011);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (AndroidVisualIDRegistry.getVisualID(incomingLink) == ActivityShowEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AndroidVisualIDRegistry.getVisualID(outgoingLink) == MenuHasItemEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (AndroidElementTypes.MenuHasItem_4004 == req.getElementType()) {
			return getGEFWrapper(new MenuHasItemCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case MenuHasItemEditPart.VISUAL_ID:
			return getGEFWrapper(new MenuHasItemReorientCommand(req));
		}
