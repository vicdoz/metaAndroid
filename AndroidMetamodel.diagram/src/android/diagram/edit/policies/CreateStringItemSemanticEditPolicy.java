 ...
 * @generated
 */
public class CreateStringItemSemanticEditPolicy extends
		AndroidBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CreateStringItemSemanticEditPolicy() {
		super(AndroidElementTypes.CreateString_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (AndroidVisualIDRegistry.getVisualID(incomingLink) == AplicationCreatesEditPart.VISUAL_ID) {
