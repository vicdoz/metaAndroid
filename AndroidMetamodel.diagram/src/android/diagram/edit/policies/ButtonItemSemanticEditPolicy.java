...
public class ButtonItemSemanticEditPolicy extends
	...
	public ButtonItemSemanticEditPolicy() {
		super(AndroidElementTypes.Button_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (AndroidVisualIDRegistry.getVisualID(incomingLink) == LayoutContainsEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AndroidVisualIDRegistry.getVisualID(outgoingLink) == ButtonTriggersEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
