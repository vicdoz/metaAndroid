...
import android.diagram.edit.policies.AndroidTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TextViewNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TextViewNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new AndroidTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return AndroidElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AndroidParserProvider
					.getParser(
							AndroidElementTypes.TextView_2012,
							getParserElement(),
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.TextViewNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					AndroidEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
