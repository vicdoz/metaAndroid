 ...
 * @generated
 */
public class CreateStringNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CreateStringNameEditPart(View view) {
		super(view);
	}
			...
			parser = AndroidParserProvider
					.getParser(
							...
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.CreateStringNameEditPart.VISUAL_ID));
		}
		return parser;
	}
