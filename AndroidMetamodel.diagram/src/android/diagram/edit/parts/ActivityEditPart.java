...
import android.diagram.edit.policies.ActivityItemSemanticEditPolicy;
...
public class ActivityEditPart extends ShapeNodeEditPart {
	...
	public class ActivityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActivityPackageFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureActivityMainFigure;
		...
		private void createContents() {
			...
			fFigureActivityPackageFigure = new WrappingLabel();

			fFigureActivityPackageFigure.setText("<...>");

			this.add(fFigureActivityPackageFigure);

			fFigureActivityMainFigure = new WrappingLabel();

			fFigureActivityMainFigure.setText("<...>");

			this.add(fFigureActivityMainFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActivityPackageFigure() {
			return fFigureActivityPackageFigure;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureActivityMainFigure() {
			return fFigureActivityMainFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 102, 102, 255);
