 ...
 * @generated
 */
public class AplicationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AplicationNameEditPart(View view) {
		super(view);
	}
			...
			parser = AndroidParserProvider
					.getParser(
							...
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.AplicationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
