 ...
 * @generated
 */
public class DialogTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DialogTextEditPart(View view) {
		super(view);
	}
			...
			parser = AndroidParserProvider
					.getParser(
							...
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.DialogTextEditPart.VISUAL_ID));
		}
		return parser;
	}
