...
import android.diagram.edit.policies.ActionItemSemanticEditPolicy;
...
public class ActionEditPart extends ShapeNodeEditPart {
	...
	public class ActionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureActionTypeFigure;
		...
		private void createContents() {
			...
			fFigureActionTypeFigure = new WrappingLabel();

			fFigureActionTypeFigure.setText("<...>");

			this.add(fFigureActionTypeFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActionTypeFigure() {
			return fFigureActionTypeFigure;
		}
