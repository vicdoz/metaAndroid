 ...
 * @generated
 */
public class MenuIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MenuIdEditPart(View view) {
		super(view);
	}
			...
			parser = AndroidParserProvider
					.getParser(
							...
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.MenuIdEditPart.VISUAL_ID));
		}
		return parser;
	}
