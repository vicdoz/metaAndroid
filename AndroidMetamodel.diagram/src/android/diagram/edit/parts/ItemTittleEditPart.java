 ...
 * @generated
 */
public class ItemTittleEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ItemTittleEditPart(View view) {
		super(view);
	}
			...
			parser = AndroidParserProvider
					.getParser(
							...
							AndroidVisualIDRegistry
									.getType(android.diagram.edit.parts.ItemTittleEditPart.VISUAL_ID));
		}
		return parser;
	}
