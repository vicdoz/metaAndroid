 ...
 * @generated
 */
public class AndroidDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AndroidDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof AndroidDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((AndroidDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new AndroidDomainNavigatorItem((EObject) objects[i],
