 ...
 * @generated
 */
public class AndroidInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new AndroidNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				MetaAppEditPart.MODEL_ID));
		AndroidDiagramEditorUtil.runWizard(getShell(), wizard,
