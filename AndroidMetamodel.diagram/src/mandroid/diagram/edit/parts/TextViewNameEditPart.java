...
import mandroid.diagram.edit.policies.MAndroidTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TextViewNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MAndroidVisualIDRegistry
						.getType(mandroid.diagram.edit.parts.TextViewNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new MAndroidTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return MAndroidElementTypes.getImage(parserElement.eClass());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					MAndroidEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
