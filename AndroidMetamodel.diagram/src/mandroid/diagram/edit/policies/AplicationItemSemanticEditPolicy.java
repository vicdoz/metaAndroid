...
import mandroid.diagram.edit.commands.ActivityCreateCommand;
import mandroid.diagram.edit.commands.LayoutCreateCommand;
...
public class AplicationItemSemanticEditPolicy extends
	...
	public AplicationItemSemanticEditPolicy() {
		super(MAndroidElementTypes.Aplication_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MAndroidElementTypes.Layout_2001 == req.getElementType()) {
			return getGEFWrapper(new LayoutCreateCommand(req));
		}
		if (MAndroidElementTypes.Activity_2002 == req.getElementType()) {
