 ...
 * @generated
 */
public class LayoutLayOnReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LayoutLayOnReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Aplication && newEnd instanceof Layout)) {
			return false;
		}
		return MAndroidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLayoutLayOn_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MAndroidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLayoutLayOn_4004(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setLayOn(null);
		getNewSource().setLayOn(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setLayOn(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
