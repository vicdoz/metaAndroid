 ...
 * @generated
 */
public class TextFieldReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TextFieldReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof TextField) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return MAndroidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTextField_4003(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return MAndroidBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTextField_4003(getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected TextField getLink() {
		return (TextField) getElementToEdit();
	}
