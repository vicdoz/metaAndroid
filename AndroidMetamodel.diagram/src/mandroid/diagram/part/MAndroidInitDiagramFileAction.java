 ...
 * @generated
 */
public class MAndroidInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new MAndroidNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				AplicationEditPart.MODEL_ID));
		MAndroidDiagramEditorUtil.runWizard(getShell(), wizard,
