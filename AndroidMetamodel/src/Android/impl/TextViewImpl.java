 ...
 * <ul>
 *   <li>{@link Android.impl.TextViewImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextViewImpl extends WidgetImpl implements TextView {
	...
	protected EClass eStaticClass() {
		return AndroidPackage.Literals.TEXT_VIEW;
	}
	...
	public void setText(Integer newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AndroidPackage.TEXT_VIEW__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AndroidPackage.TEXT_VIEW__TEXT:
				return getText();
		}
