 ...
 * @generated
 */
public class MandroidFactoryImpl extends EFactoryImpl implements MandroidFactory {
	/**
	 ...
	 * @generated
	 */
	public static MandroidFactory init() {
		try {
			MandroidFactory theMandroidFactory = (MandroidFactory)EPackage.Registry.INSTANCE.getEFactory(MandroidPackage.eNS_URI);
			if (theMandroidFactory != null) {
				return theMandroidFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new MandroidFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MandroidPackage.ACTIVITY: return createActivity();
			case MandroidPackage.WIDGET: return createWidget();
			case MandroidPackage.LAYOUT: return createLayout();
			case MandroidPackage.BUTTON: return createButton();
			case MandroidPackage.TEXT_VIEW: return createTextView();
			case MandroidPackage.APLICATION: return createAplication();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case MandroidPackage.PERMISSIONS:
				return createPermissionsFromString(eDataType, initialValue);
			case MandroidPackage.LAYOUT_TYPE:
	 ...
	 * @generated
	 */
	public MandroidPackage getMandroidPackage() {
		return (MandroidPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static MandroidPackage getPackage() {
		return MandroidPackage.eINSTANCE;
	}
