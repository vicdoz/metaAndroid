...
/**
 * This is the item provider adapter for a {@link mandroid.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MandroidPackage.Literals.ACTIVITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_package_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_package_feature", "_UI_Activity_type"),
				 MandroidPackage.Literals.ACTIVITY__PACKAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_main_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_main_feature", "_UI_Activity_type"),
				 MandroidPackage.Literals.ACTIVITY__MAIN,
				 true,
				 false,
				 false,
	...
	protected void addMuestraPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_muestra_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_muestra_feature", "_UI_Activity_type"),
				 MandroidPackage.Literals.ACTIVITY__MUESTRA,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MandroidPackage.Literals.ACTIVITY__SHOW);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MandroidPackage.Literals.ACTIVITY__SHOW,
				 MandroidFactory.eINSTANCE.createMenu()));
	}
