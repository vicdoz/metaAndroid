...
/**
 * This is the item provider adapter for a {@link mandroid.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_triggers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_triggers_feature", "_UI_Button_type"),
				 MandroidPackage.Literals.BUTTON__TRIGGERS,
				 true,
				 false,
				 true,
				 null,
