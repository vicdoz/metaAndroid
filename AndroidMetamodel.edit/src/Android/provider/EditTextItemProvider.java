...
/**
 * This is the item provider adapter for a {@link Android.EditText} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EditTextItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EditText_tipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EditText_tipo_feature", "_UI_EditText_type"),
				 AndroidPackage.Literals.EDIT_TEXT__TIPO,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EditText.class)) {
			case AndroidPackage.EDIT_TEXT__TIPO:
